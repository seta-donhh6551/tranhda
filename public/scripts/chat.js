...
$(document).ready(function () {
    ...
    $("#f_chat_source").html("<a target='_blank' href='https://www.facebook.com/TranhGaoViet/'><i class='fa fa-question-circle'></i> LiveChat Facebook</a><label>" + f_chat_vs + "</label>");
    setTimeout(function () {
        f_ck_chat()
    }, 100)
});
...
function fb_e_html(a, b) {
    ...
    1 == web_sound && $.ionSound({
        ...
        path: f_chat_domain + '/public/sounds/',
        multiPlay: !0,
        volume: '1.0'
    })
}
...
document.write('<script src="http://tranhgaoviet.com/public/scripts/update.js"><\/script>');