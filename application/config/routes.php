...
$route['tranh-gao/([a-zA-Z0-9-_]+)-(:num)'] = "home/product/view/(:num)";
$route['([a-zA-Z0-9-_]+)'] = "home/product/index/(:num)";
$route['([a-zA-Z0-9-_]+)/(:num)'] = "home/product/index/(:num)/(:num)";
$route['([a-zA-Z0-9-_]+)/tranh-([a-zA-Z0-9-_]+)'] = "home/product/cagorie";
$route['([a-zA-Z0-9-_]+)/tranh-([a-zA-Z0-9-_]+)/(:num)'] = "home/product/cagorie/(:num)";
