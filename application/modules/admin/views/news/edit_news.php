								...
								<div class="table_wrapper_inner">
                                    ...
                                    <div class="form_items">
                                        ...
                                        <div class="form_items_right">
                                        	<textarea name="news_keys" cols="28" rows="5"><?php echo $get['news_keys']; ?></textarea>
                                        </div>
                                    </div>
                                    <div class="form_items">
                                    	<div class="form_items_left">SEO description</div>
                                        <div class="form_items_right">
                                        	<textarea name="news_des" cols="28" rows="5"><?php echo $get['news_des']; ?></textarea>
                                        </div>
                                    </div>
                                    <div class="form_items">
                                        ...
                                        <select name="cate_id">
                                        <?php
										foreach($listte as $items){
											echo "<option value='".$items['cate_id']."'";
											if($items['cate_id'] == $stt){ echo "selected='selected'";}
											echo ">".$items['cate_name']."</option>";
										}
										?>
                                        </select>
                                        </div>
