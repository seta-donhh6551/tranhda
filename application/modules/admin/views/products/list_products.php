					...
					<div class="section_content">
						...
						<div class="section_content_inner minheight">
                            ...
                            <ul class="table_tabs">
								...
								<li><a href="<?php echo base_url(); ?>admin/products/add" name=""><span><span>Thêm mới</span></span></a></li>
							</ul>
									...
									foreach($info as $items){
										...
										echo "<td>";
												echo "<div class='actions_menu'><ul>";
													echo "<li><a href='".base_url()."admin/products/update/$items[pro_id]/' class='edit'>Edit</a></li>";
													echo "<li><a href='".base_url()."admin/products/del/$items[pro_id]/' class='delete' onclick='return check()'>Del</a></li>";
												echo "</ul></div>";
											echo "</td>";
