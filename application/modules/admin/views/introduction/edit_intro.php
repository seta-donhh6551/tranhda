...
<!--[if !IE]>start table_wrapper<![endif]-->
            <div class="table_wrapper" style="background:none;">
                <div class="table_wrapper_inner">
                    ...
                    <form action="<?php echo base_url()?>admin/intro/update/<?php echo $list['in_id']?>" method="post" enctype="multipart/form-data">
                    <table width="835" border="0" align="center">
                      <tr>
                        <td width="138" height="12">Tiêu đề</td>
                        <td width="687"><input name="in_name" type="text" id="in_name" value="<?php echo $list['in_name']; ?>" size="35"></td>
                      </tr>
                      <tr>
                        <td width="138" height="12">Thứ tự</td>
                        <td width="687"><input name="in_order" type="text" value="<?php echo $list['in_order']; ?>" size="35"></td>
                      </tr>
                      <tr>
                      ...
                      <tr>
                        ...
                        <td>	
                        	<textarea name="in_keys" cols="30" rows="5"><?php echo $list['in_keys']; ?></textarea>
                        </td>
                      </tr>
                      <tr>
                        <td width="138" height="23">Description</td>
                        <td>	
                        	<textarea name="in_des" cols="30" rows="5"><?php echo $list['in_des']; ?></textarea>
                        </td>
                      </tr>
                      <tr>
