				...
				<!--[if !IE]>start table_wrapper<![endif]-->
							<div class="table_wrapper" style="background:none;">
								<div class="table_wrapper_inner">
									...
									<form action="<?php echo base_url()."admin/subjects/add/";?>" method="post" name="sac" onsubmit="return checkuser()" enctype="multipart/form-data">
                            		<div class="form_items">
                                    	<div class="form_items_left">Tên khoá</div>
                                        <div class="form_items_right"><input name="subject_title" type="text" id="subject_title" size="35" /></div>
                                    </div>
                                    <div class="form_items">
                                    	<div class="form_items_left">Thứ tự</div>
                                        <div class="form_items_right"><input name="subject_order" type="text" id="subject_order" size="35" /></div>
                                    </div>
                                    <div class="form_items">
