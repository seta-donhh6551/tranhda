							...
							<div class="table_wrapper" style="background:none;">
								<div class="table_wrapper_inner">
                                    ...
                                    <form action="<?php echo base_url()?>admin/cate/updatemn/<?php echo $list['cate_id']?>" method="post" name="sac" onsubmit="return check()" enctype="multipart/form-data">
                                         ...
                                         <div class="form_items">
                                    		<div class="form_items_left">Seo title</div>
                                         ...
                                         <div class="form_items">
                                        	...
                                        	<div class="form_items_right">
                                              <textarea name="cate_keys" cols="30" rows="5"><?php echo $list['cate_keys']; ?></textarea>
                                            </div>
                                   		 </div>
                                         <div class="form_items">
                                    		<div class="form_items_left">Description</div>
                                        	<div class="form_items_right">
                                              <textarea name="cate_des" cols="30" rows="5"><?php echo $list['cate_des']; ?></textarea>
                                            </div>
                                   		 </div>
                                         <div class="form_items">
											...
											if($list['cate_images'] != NULL){
												echo "<img src='".base_url()."uploads/cate/".$list['cate_images']."' width='140' />";
											}
											?>
