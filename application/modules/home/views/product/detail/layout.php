...
<meta name="keywords" content="<?php echo $result['pro_keys']." ".$config['config_key']; ?>" />
<meta name="description" content="<?php echo $result['pro_des']." ".$config['config_des']; ?>" />
<meta property="og:type" content="blog" />
<meta property="og:title" content="<?php echo $result['pro_keys']." ".$config['config_title']; ?>" />
<meta property="og:description" content="<?php echo $result['pro_des']." ".$config['config_des']; ?>" />
...
<div class="body">
  <div id="wrapper">
    ...
    <?php $this->load->view("product/detail/content"); ?>
