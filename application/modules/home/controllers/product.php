<?php
   class product extends MY_Controller{
	   ...
	   public function index(){
		   ...
		   //$this->debug($result);
		   if($result == NULL){ redirect(base_url());}
		   $id = $result['cate_id'];
		   ...
		   $data['listcago'] = $this->model_product->listcago($id);
		   $data['listnews'] = $this->model_product->listnews($id);
		   ...
		   if($data['cate'] == NULL){ redirect(base_url());}
